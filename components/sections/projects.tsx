          ...
          <div className="space-y-2">
            ...
            <div className="flex items-center gap-2 justify-between">
              ...
              <ButtonWithTooltip
                ...
                className="shrink-0"
                tooltipText={project.showDate ? "Hide date" : "Show date"}
                ariaLabel={project.showDate ? "Hide project date" : "Show project date"}
                icon={project.showDate ? <Eye className="h-4 w-4" /> : <EyeOff className="h-4 w-4" />}
              />
            </div>
          </div>
